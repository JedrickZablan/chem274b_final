...
//      Neighborhood: VON_NEUMAN_NEIGH
//      States: 0 healthy cells, 1 cancer cells
//      Rulles: considering 0.15 probability
...
int main()
{
    ...
    double rule_probability = 0.15;
    err = myCA_2D.CA_setup_rule_wprob(CA_2D,rule_types, rule_probability);
    if (err==0)
    {
    ...
    myCA_2D.compute_with_prob_report(CA_2D, 100, 5); 
